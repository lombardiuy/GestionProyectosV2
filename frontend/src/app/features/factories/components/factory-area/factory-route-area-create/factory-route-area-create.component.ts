...
@Component({
  selector: 'factory-route-area-create-component',
  templateUrl: './factory-route-area-create.component.html',
  styleUrls: ['./factory-route-area-create.component.scss'],
  standalone:false
})



export class FactoryRouteAreaCreateComponent  {
